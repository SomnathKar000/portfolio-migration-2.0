export default {
  ...
  aboutMe: `
      <p>I'm a Software Engineer passionate about building intuitive and beautiful web applications. </p>
      <p> I specialize in Vue.js and modern frontend technologies. My goal is to create seamless user 
      experiences with scalable and maintainable code.  </p>
    `,
  projects: [
    {
    ...
    data: [
      {
        ...
        feedback:
          "Somnath was hired to create a corporate identity. We were very pleased with the work done. She has a lot of experience and is very concerned about the needs of client. Lorem ipsum dolor sit amet, ullamcous cididt consectetur adipiscing elit, seds do et eiusmod tempor incididunt ut laborels dolore magnarels alia.",
      },
      {
        name: "Jessica Miller",
  ...
  clients: {
    ...
    data: [
      {
        name: "",
        src: "/assets/logo-1-color.png",
      },
      {
        name: "",
        src: "/assets/logo-2-color.png",
      },
      {
        name: "",
        src: "/assets/logo-3-color.png",
      },

      {
        name: "",
        src: "/assets/logo-4-color.png",
      },
      {
        name: "",
        src: "/assets/logo-5-color.png",
      },
      {
        name: "",
        src: "/assets/logo-6-color.png",
      },
    ],
  },
};
